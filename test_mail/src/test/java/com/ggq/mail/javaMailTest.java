...
public class javaMailTest {
    ...
    private static final String USERNAME = "guo1627196136@163.com";//163邮箱账号
    private static final String PASSWORD = "MQQUIPIFRLHOMQHT";//163邮箱---授权码
    private static final String EMAILFORM = "guo1627196136@163.com";  //发送邮件的用户
    ...
    public static void main(String[] args) {
        sendHtmlMail("guoqq18554218043@163.com", EMAILTOPNAME, "数据入库异常！ CoderZS 我在简书等你");
    }
